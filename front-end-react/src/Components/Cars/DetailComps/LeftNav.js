...
//   const showEFunction = (boolean)=>{
// setShowEForm(boolean)
//   }
  return (

<>
      <img src="https://uxwing.com/wp-content/themes/uxwing/download/07-web-app-development/hamburger-menu.png" style={{height:"40px",width:"40px"}} className="hamb" onClick={()=>setShowComp(!showComp)}/>

    <div className="left-nav">
        {showEForm && (<ModalNewExpenseForm setShowEForm={setShowEForm} showEForm={showEForm}/>)}   
        {showTripForm && (<ModalNewTripForm setShowTripForm={setShowTripForm} showTripForm={showTripForm}/>)}   
      <div className="chrome">
        <div className="nav-expenses" onClick={() => setShowEForm(!showEForm)}>
  ...
  <p>  ✚ Enter Expense</p>
      ...
      <div className="chrome">
        <div className="nav-expenses" onClick={() => setShowTripForm(!showTripForm)}>
