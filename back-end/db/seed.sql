...
VALUES 
((SELECT id FROM cars WHERE vin = 123),true,100,2008-11-11)
...
VALUES 
((SELECT id FROM gas WHERE vin = 123),true,10000,2008-11-11,"deliver", 500,5000, false)
((SELECT id FROM gas WHERE vin = 234),true,10000,2009-01-14,"date night", 800,7000,true)
((SELECT id FROM gas WHERE vin = 567),true,10000,2011-14-11,"deliver", 500,5000, false)
